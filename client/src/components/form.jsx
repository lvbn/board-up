      ...
      <div className='bg-black text-base'>
        ...
        <form className="text-accent m-2" onSubmit={handleSubmit}>
          ...
          <div className='flex flex-row mb-2'>
            <textarea rows='3' cols='40' style={{resize:'none'}} value={item.location} name='location' placeholder=" address or venue.."
              className='bg-black text-slate-300 border rounded-md' onChange={handleChange} required >
            </textarea>
          </div>
          <div className='mb-2'>
            ...
            className='bg-black text-slate-300 border rounded-md dark:text-slate-300 dark:[color-scheme:dark]' onChange={handleChange} required />
          </div>
          <br/>
          <label>Details:  </label>
          <div className='mb-2'>
            <textarea rows='3' cols='40' style={{resize:'none'}} value={item.details} name='details' placeholder=" Tell us more :)"
              className='bg-black text-slate-300 border rounded-md' onChange={handleChange} required>
            </textarea>
          </div>
          <div className='mb-2'>
            <label>Your email:  </label>
            <input type='email' size='29' value={item.email} name='location' placeholder=" dungeons@dragons.dnd"
            className='bg-black text-slate-300 border rounded-md' onChange={handleChange} required />
          </div>
          <br />
