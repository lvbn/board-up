  ...
  return (
    ...
    <Tabs.Content className="pr-5 pl-5 pb-5 pt-5 border border-1 rounded font-mono text-base" value="tab1">
      ...
      <fieldset>
        ...
        <input
          // size="30"
          className="text-black" id="lastname" placeholder="Snow" />
      </fieldset>
      <fieldset>
        <label className="">
          Username
        ...
        <input
          // size="30"
          className="text-black" id="username" placeholder="johnsnow" />
      </fieldset>
      <fieldset>
        <label className="">
          Email
        ...
        <input
          // size="30"
          className="text-black" id="email" placeholder="night@watch.wall" />
      </fieldset>
      <fieldset className="">
        <label className="" >
        password
        ...
        <input
          // size="30"
          className="text-black" type="password" />
      </fieldset>
    ...
    <Tabs.Content className="pr-5 pl-5 pb-5 pt-5 border border-1 rounded font-mono text-base" value="tab2">
      ...
      <fieldset className="">
        ...
        <input
          // size="30"
          className="text-black" type="email" />
      </fieldset>
      <fieldset className="">
        <label className="" >
        password
